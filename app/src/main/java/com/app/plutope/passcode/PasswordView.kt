...
import com.app.plutope.passcode.animation.Animator
import com.app.plutope.passcode.animation.FillAndStrokeColorChangeAnimation
import com.app.plutope.passcode.animation.FillColorChangeAnimation
import com.app.plutope.passcode.animation.ShakeAnimator
import com.app.plutope.passcode.animation.SpringAnimator
...
class PasswordView @JvmOverloads constructor(
    ...
    companion object {
        ...
        private val DEFAULT_INPUT_COLOR = Color.parseColor("#00C6FB")
        private val DEFAULT_NOT_INPUT_COLOR = Color.parseColor("#75769D")
        ...
        private const val DEFAULT_OUTLINE_STROKE_WIDTH = 0f
    }
    ...
    private val notInputColor =
        array.getColor(R.styleable.PasswordView_password_input_color, DEFAULT_NOT_INPUT_COLOR)
