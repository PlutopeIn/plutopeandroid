...
class ConnectionsViewModel : ViewModel() {
    ...
    private fun getConnectionUI(): ConnectionUI? =
        connections.value.firstOrNull { it.id == currentConnectionId }

    val connections: StateFlow<List<ConnectionUI>> =
        signConnectionsFlow.stateIn(
            viewModelScope,
